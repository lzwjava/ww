...
def identity_block_test(target):
    ...
    np.random.seed(1)
    tf.random.set_seed(2)
    A4 = target(X, f=3, filters=[3, 3, 3], initializer=lambda seed=7: constant(value=1))
    A4np = A4.numpy()
...
def convolutional_block_test(target):
    ...
    convolutional_block_output1 = [
        [
            [
                [0.0, 0.77726924, 0.0, 1.499777, 0.0, 0.0],
                [0.0, 1.026826, 0.0, 1.2753085, 0.0, 0.0],
            ],
            [
                [0.0, 1.0379409, 0.0, 1.665507, 0.0, 0.0],
                [0.0, 1.0401409, 0.0, 1.3495028, 0.0, 0.0],
            ],
        ],
        [
            [
            ...
            [
                [0.0, 3.1137722, 0.0, 4.9962516, 0.0, 0.0],
                [0.0, 3.120653, 0.0, 4.048527, 0.0, 0.0],
            ],
        ],
    ]
    ...
    convolutional_block_output2 = [
        [
            [
                [0.0, 2.4545407, 2.0499215, 0.21395457, 1.9233333, 0.0],
                [0.0, 2.1593804, 1.8172791, 0.0, 1.7905258, 0.0],
            ],
            [
                [0.0, 1.8572202, 1.5051603, 0.0, 1.0648199, 0.0],
                [0.0, 1.6594248, 1.3452594, 0.0, 0.94392204, 0.0],
            ],
        ],
        [
            [
                [0.0, 0.05097151, 0.0, 0.0039694, 0.8759659, 1.0296324],
                [0.0, 0.05097151, 0.0, 0.0039694, 0.8759659, 1.0296324],
            ],
            [
                [0.0, 0.05097151, 0.0, 0.0039694, 0.8759659, 1.0296324],
        ...
        [
            [
                [2.0033183, 0.0, 0.0, 2.48448, 0.0, 0.303159],
                [1.4685479, 0.0, 0.0, 1.3042265, 0.0, 1.56749],
            ],
            [
                [3.1580768, 0.0, 0.0, 0.0, 0.0, 1.137401],
                [1.844996, 0.0, 0.0, 0.15629888, 0.0, 2.360362],
            ],
        ],
    ]
    ...
    assert np.allclose(B.numpy(), convolutional_block_output2), (
