...
def get_battery_info():
    if psutil is None:
        print("psutil not installed. Cannot retrieve battery info via psutil.")
        return
    ...
    try:
        ...
        if not is_charging and battery.secsleft != psutil.POWER_TIME_UNLIMITED:  # type: ignore
