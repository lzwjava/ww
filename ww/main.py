...
def main():
    if len(sys.argv) > 1:
        ...
        if cmd == "create-note":
            ...
            print("Usage: ww <command> [options]")
            print("")
            print("Commands:")
            print("  create-note         Create a new note with git integration")
            print("  create-log          Create a new log entry")
            print("  gif                 Create GIF from images")
            print("  gitmessageai        Generate AI commit message and commit")
            print("  github-readme       Generate GitHub README markdown")
            print("  find-large-dirs     Find largest directories on disk")
            print("  system-info         Show system information")
            print("  mac-install         Run macOS install tasks")
            ...
            print("  screenshot-linux    Take a screenshot (Linux)")
            print("  image-compress      Compress images")
            print("  photo-compress      Compress photos")
            print("  kill-by-pattern     Kill processes matching a pattern")
            print("  kill-by-port        Kill process on a given port")
            print("  kill-jekyll         Kill Jekyll server")
            print("  kill-macos-proxy    Kill macOS proxy")
            ...
            print("  git-amend-push      Amend last commit and force push")
            print("  git-classify        Classify git commits")
            print("  find-commit         Find a git commit")
            print("  git-delete-commit   Delete a git commit")
            print("  git-diff-tree       Show git diff tree")
            print("  git-check-filenames Check git filenames")
            print("  git-force-push      Force push to remote")
            print("  git-show            Show git commit details")
            print("  git-squash          Squash git commits")
            ...
            print("  search              Web search (multi-engine)")
            print("  search-bing         Search with Bing")
            print("  search-code         Search code")
            print("  search-ddg          Search with DuckDuckGo")
            print("  search-ecosia       Search with Ecosia")
            print("  search-filename     Search by filename")
            print("  search-startpage    Search with StartPage")
        else:
