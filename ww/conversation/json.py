...
def resolve_output_path(filename: str, output_dir: str) -> str:
...
def write_conversation(filename: str, data: Any, output_dir: str) -> str:
    output_path = resolve_output_path(filename, output_dir)
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Capture conversation JSON and save it to a file."
    )
    ...
    output_path = write_conversation(args.filename, conversation, args.output_dir)
